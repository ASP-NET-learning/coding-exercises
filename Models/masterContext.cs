...
public partial class masterContext : DbContext
{
    ...
    public virtual DbSet<EmployeeBackup> EmployeeBackup { get; set; }
    ...
    public virtual DbSet<Shippers1> Shippers1 { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__Ai__3214EC2748CD23E9");
        ...
        modelBuilder.Entity<Categories1>(entity =>
        {
            ...
            entity.ToTable("Categories", "guest");
        ...
        modelBuilder.Entity<Customer_and_Suppliers_by_City1>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Customer and Suppliers by City", "guest");
        ...
        modelBuilder.Entity<Customers1>(entity =>
        {
            ...
            entity.ToTable("Customers", "guest");
        ...
        modelBuilder.Entity<Shippers1>(entity =>
        {
            entity.HasKey(e => e.ShipperID);

            entity.ToTable("Shippers", "guest");
        ...
        modelBuilder.Entity<Suppliers1>(entity =>
        {
            ...
            entity.ToTable("Suppliers", "guest");
